...
export default function LandFinancingPage() {
  return (
    <>
      <NormalHeros
        img="/personal-hero-account.png"
        title="Land Financing Account"
      ...
      />
      <Title label="Features of" labelC="Land financing Account" />
      <SectionList isBg items={features} />
