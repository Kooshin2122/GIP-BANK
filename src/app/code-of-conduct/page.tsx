...
export default function CodeOfConduct() {
    ...
    const Applicability = [
        { title: "This code of conduct contained in this guideline is applicable to Directors, Managing Director, and Management and Officers of Galaxy International Bank (GIB). The Board of Directors should ensure that all officers adhere to all the elements of the prescribed code of conduct, stated below." }
    ]
    //
    return (
        <>
            ...
            <div className="bg-white">
                <div className="bg-white sm:w-[80%] py-5 sm:px-10 gapy-5">
                    ...
                    <SectionList
                        ...
                        items={Applicability}
                    />
                    <Title label="Prescribed Code of Conduct and Ethics Policy" />
